#include "Arduino.h"
#define kontroll_led 5  // Ausgang zur Kontroll-LED
#define ntc A0           // NTC-Wert
//#define mosfet_out 1; // Spannungsberwachung
#define taster 7       // Taster Eingabe
#define mosfet_gate 6  // Gate Mosfet Heizdecke
